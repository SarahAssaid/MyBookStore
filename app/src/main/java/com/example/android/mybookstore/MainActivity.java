...
public class MainActivity extends AppCompatActivity {
    ...
    private void insertBook() {
        ...
        values.put(BookContract.BookEntry.COLUMN_PRODUCT_NAME, "Book 1");
        values.put(BookContract.BookEntry.COLUMN_BOOK_PRICE, 15);
        values.put(BookContract.BookEntry.COLUMN_BOOK_QUANTITY, 30);
        values.put(BookContract.BookEntry.COLUMN_SUPPLIER_NAME, "Baker & Taylor");
        values.put(BookContract.BookEntry.COLUMN_SUPPLIER_PHONE, "00011112222");
